...
class UI:
    def __init__(self):
        ...
        #De-construct Weapon Dictionary to get weapon path 
        ...
        #De-construct magic Dictionary to get magic path 
        self.magic_graphics = []
    ...
    def show_exp(self, exp):
        #convert to int to get rid of odd floats, then to a string so it will work
    ...
    def magic_overlay(self, magic_index, has_switched):
        bg_rect = self.selection_box(95, 630, has_switched) #magic box
